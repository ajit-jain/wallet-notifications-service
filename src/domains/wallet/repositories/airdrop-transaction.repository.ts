...
export class AirdropTransactionRepository implements AirdropTransactionRepositoryInterface {
    ...
    async create(airdropTransactionEntity: AirdropTransactionEntity): Promise<void> {
